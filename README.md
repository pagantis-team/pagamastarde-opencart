# Módulo de opencart 2.0.x - 2.1.x para pagamasterde.com


## Instrucciones de Instalación

1. Crea tu cuenta en Pagantis.com si aún no la tienes [desde aquí](https://bo.pagantis.com/users/sign_up)
2. Descarga el módulo de [aquí](https://github.com/pagantis/pagamastarde-opencart/releases/1.0.0/1.0.0.zip)
3. Sube el contenido de la carpeta upload al directorio root ( / ) de tu instalación opencart
...
El manual de instalación y uso del módulo se puede consultar [aquí](https://github.com/pagantis/pagamastarde-opencart/Guide.pdf).
